...
From the ancient forests of Sri Lanka to kitchen shelves across the globe, Ceylon cinnamon remains a timeless treasure. It is more than a spice; it is a story of tradition, unparalleled quality, and a nation's enduring gift to the world.`,
  },
  {
    ...
    date: "AUGUST 12, 2023",
    image: "/blog/4.jpg",
    excerpt: "Thelme costume may refer to as the main ...",
    tags: ["Traditional","Sri Lanka","Low Country","Dance","Main Costume","Unique"],
    author: "Dinuka Gunawardana",
    photographer: "© Dinuka Gunawardana",
    content: `Thelme costume may refer to as the main costume of low country dance tradition. This costume arrangement is very beautifully and colorfully arranged. In addition to that, low-country dancers are using many more costume sets. This thelme costume is mostly used in shanthikarama.
...
“ pahatharata beraya” is used in this low country dancing as the drum. Because of it’s long shape, it is called as “Dik beraya”. Also this is called as “goshaka beraya”, because of its loud sound. As well as this is called as “Yak beraya”, because it is used for Yak thovil. This drum is unique to Ruhunu area, so some people called this drum as “Ruhunu beraya”. Likethis, this drum is in use under several terms. It is special that the drum is made using skins that are taken from animals..`,
  ...
  /*
  {
    ...
    date: "අගෝස්තු 3, 2023",
    image: "/blog/5.jpg",
    excerpt: "“Summit Level” යනු ශ්‍රී ලංකාවේ මධ්‍යම කඳුකරය...",
    tags: ["Sri Lanka", "Wet Zone", "Beautiful",  "Tourism"],
    author: "දිනුක ගුණවර්ධන",
    photographer: "© Praveen Katukithule",
    content: `“Summit Level” යනු ශ්‍රී ලංකාවේ මධ්‍යම කඳුකරය හරහා දිවෙන ප්‍රධාන දුම්රිය මාර්ගයේ උසම ස්ථානයයි. මෙය නුවරඑළිය දිස්ත්‍රික්කයේ පට්ටිපොල දුම්රිය ස්ථානයේ සිට මීටර් 800 ක දුරින් පිහිටා ඇත.

කොළඹ සහ බදුල්ල සම්බන්ධ කරන ප්‍රධාන දුම්රිය මාර්ගය, මනරම් භූ දර්ශන, තේ වතු, කඳු සහ නිම්න රැසක් පිරි ඉතා දර්ශනීය ය ගමන් මාර්ගයකි. Summit Level වටා ඇති පරිසරය විශේෂයෙන් විශ්මයජනක දසුන් සපයන අතර සංචාරකයින් බොහෝ දෙනා පැමිණෙන ජනප්‍රිය කලාපයක් වේ . මෙම ස්ථානය නැරඹීමට පට්ටිපොළ දුම්රිය ස්ථානයේ දුම්රිය ස්ථානාධිපතිවරයාගෙන් අවසරයක්ද ලබා ගත යුතු බව දුම්රිය මාර්ගයේ අලුත් වැඩියා කටයුතුවල නිරතව සිටි අයෙක් පැවසීය.
